...
export const siteConfig: SiteConfig = {
	title: "Choria",
	subtitle: "ChoriaKiinweill's Blog",
	siteURL: "https://www.choria.top", // 请替换为你的站点URL，以斜杠结尾
	...
	navbarTitle: {
		...
		mode: "text-icon",
		// 顶栏标题文本
		text: "ChoriaKiinweill",
		// 顶栏标题图标路径，默认使用 public/assets/home/home.webp
		icon: "assets/home/carla.webp",
		// 网站Logo图片路径
	...
	bangumi: {
		userId: "ChoriaKiinweill", // 在此处设置你的Bangumi用户ID，可以设置为 "sai" 测试
		fetchOnDev: false, // 是否在开发环境下获取 Bangumi 数据（默认 false），获取前先执行 pnpm build 构建 json 文件
	},

	bilibili: {
		vmid: "108152994", // 在此处设置你的Bilibili用户ID (uid)，例如 "1129280784"
	...
	banner: {
		...
		src: {
			desktop: [
				"/assets/desktop-banner/makursi (9).webp",
				"/assets/desktop-banner/makursi (10).webp",
				"/assets/desktop-banner/makursi (8).webp",
				"/assets/desktop-banner/makursi (7).webp",
				"/assets/desktop-banner/makursi (6).webp",
				"/assets/desktop-banner/makursi (5).webp",
				"/assets/desktop-banner/makursi (1).webp",
				"/assets/desktop-banner/makursi (2).webp",
				"/assets/desktop-banner/makursi (3).webp",
				"/assets/desktop-banner/makursi (4).webp",
			], // 桌面横幅图片
			mobile: [
				"/assets/mobile-banner/suiyi (1).webp",
				"/assets/mobile-banner/suiyi (2).webp",
				"/assets/mobile-banner/suiyi (3).webp",
				"/assets/mobile-banner/suiyi (4).webp",
			], // 移动横幅图片
		}, // 使用本地横幅图片
		...
		homeText: {
			...
			title: "往页之所以珍贵", // 主页横幅主标题

			subtitle: ["望着风儿吹回那日", "最后的犹豫,那戛然而止的一页..."],
			typewriter: {
	...
	links: [
		...
		// 支持自定义导航栏链接，支持多级菜单
		{
			...
			children: [
				{
					name: "GitHub",
					url: "https://github.com/makursi",
					external: true,
					icon: "fa7-brands:github",
				},
				{
					name: "Bilibili",
					url: "https://space.bilibili.com/108152994",
					external: true,
...
export const pioConfig: import("./types/config").PioConfig = {
	...
	dialog: {
		welcome: "Welcome to ChoriaKiinweill Castle!", // 欢迎词
		touch: [
			"What are you doing?",
			"Stop touching me!",
			"HENTAI!",
